...
from .commands import commandHello, commandSaveLandmark, commandShowEggs, commandUpdateMyselfPosition
...
if __name__ == '__main__':
    ...
    gameProtocol.register_command(command='/showEggs', callback=commandShowEggs)
